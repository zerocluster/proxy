...
export default class extends App {
    ...
    async #auth ( connection, password ) {
        ...
        if ( user.whitelist && !subnets.contains( user.whitelist, connection.remoteAddr ) && !subnets.contains( "local", connection.remoteAddr ) && !subnets.contains( "private", connection.remoteAddr ) ) return false;
