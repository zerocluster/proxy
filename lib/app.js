...
export default class extends App {
    ...
    async #auth ( connection, password ) {
        ...
        if ( user.whitelist && !subnets.contains( user.whitelist, connection.remoteAddress ) && !subnets.contains( "local", connection.remoteAddress ) && !subnets.contains( "private", connection.remoteAddress ) ) return false;
