...
module.exports = class {
    ...
    async _auth ( connection, password ) {
        ...
        const user = this.#users[connection.options.user];
        ...
        // authorized
        return { "user": connection.options.user };
    }
    ...
    async #getSessionProxy ( connection ) {
        const session = connection.options.user + "/" + connection.options.zone + "/" + connection.options.session;
